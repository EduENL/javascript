...
// Selecionando todas as TAG's pelo h2
...
// Cor de fundo (body)
pagina.style.backgroundColor = "lightgray";

// Mudando o segundo h2
subtitulo[1].textContent = "Full-Stack";

// Mudando a legenda (fig)
...
tituloEditores.style.color = 'darkgray';
...
terceiroItem. style.color = 'brown';
